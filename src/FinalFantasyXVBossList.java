...
//        playerLevel.setText("Recommended Player Level: 37 - 43");
    ...
    private void bossStatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bossStatsActionPerformed
/**
 ...
 */
    ...
    }//GEN-LAST:event_bossStatsActionPerformed

    private void bossListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bossListActionPerformed
/**
 * this section of code allows for the user to select which boss they want to
 * view.
 */
        bossList.getSelectedItem();
    }//GEN-LAST:event_bossListActionPerformed
